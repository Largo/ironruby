...
when 'ironruby'
  # IronRuby: psych.so's parser and emitter are IronRuby's own YAML engine, and
  # psych/ironruby.rb is the rest of the native layer. Everything else here and
  # under psych/ is psych 5.3.1 unchanged.
  require_relative 'psych/ironruby'
else
  require 'psych.so'
end

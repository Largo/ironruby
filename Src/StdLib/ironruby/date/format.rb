# Parsing half of Ruby's date library.
#
# IronRuby implements the Date/DateTime *core* (the Julian-day representation,
# the calendar reform, arithmetic and strftime) in C# under Src/Libraries/Date,
# mirroring MRI's date_core C extension.  MRI's date__parse is a large body of
# regular-expression scanning with no numeric content, so it is kept in Ruby:
# this file is the vendored 1.9 date/format.rb with the formatting half (emit,
# strftime, to_s, ...) removed, since the C# side owns those now.
#
# Original: format.rb, written by Tadayoshi Funaba 1999-2009.

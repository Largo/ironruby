...
if RUBY_ENGINE == "ironruby" and !ENV["PRISM_FFI_BACKEND"]
  # IronRuby *is* prism: libprism is what parses every file this interpreter
  # runs, reached through P/Invoke from Src/Prism.  The serialization API this
  # library needs is therefore already linked in, and the ffi gem - itself a C
  # extension, which IronRuby has no way to load - is not involved.
  Prism::BACKEND = :CEXT

  require "prism/ironruby"
elsif RUBY_ENGINE == "ruby" and !ENV["PRISM_FFI_BACKEND"]

...
namespace IronRuby.StandardLibrary.Zlib {
    ...
    public static class Zlib {
        ...
        public class Inflate : ZStream {
            ...
            /// <summary>Raw inflate of a complete deflate stream - used by GzipReader.</summary>
            internal static MutableString/*!*/ InflateRaw(byte[]/*!*/ data, int windowBits) {
                using (var z = new Inflate(windowBits)) {
                    z.Run(data, LibZ.Z_FINISH, null);
                    return z.TakeBuffer();
                }
            }
        }
...
#pragma warning restore 168,219
            ...
            public static MutableString/*!*/ Read(GZipReader/*!*/ self) {
                return Inflate.InflateRaw(self._contents.ToByteArray(), -MAX_WBITS);
            }
